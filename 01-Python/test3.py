...
df1=df.rename(columns={'tambe':'TAMBE'})
df1['TAMBE']
##############################################################

#Q2. Convert your column into list
df2=df1['TAMBE'].tolist()
df2
...
sns.countplot(x='TAMBE',data=df1)
...
df
df2=df.index[df['Name']=='Tambe_Athrva']
df[29:30].max()
